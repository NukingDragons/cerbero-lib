...
use kerberos_asn1::{AsReq, Asn1Object, KdcReq, KerbPaPacRequest, KerberosTime, PaData, PrincipalName, TgsReq, Ticket};
...
impl KdcReqBuilder
{
	...
	{
		self.cname(Some(PrincipalName { name_type: principal_names::NT_PRINCIPAL, name_string: vec![username] }))
	}
	...
	{
		self.push_padata(PaData::new(pa_data_types::PA_PAC_REQUEST, KerbPaPacRequest::new(true).build()))
	}
